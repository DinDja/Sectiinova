    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <main className=" mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-[380px_1fr] gap-8">
          ...
          <section>
            {activeTab === "guia" && (
              <GuiaINPI onOpenPesquisa={() => setIsPesquisaModalOpen(true)} />
            )}
    ...
    <div className="space-y-8 animate-in fade-in duration-500 relative">
      <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        ...
        <p className="text-slate-600 mb-4">
          Uma patente é um título de propriedade temporária concedido pelo
          Estado, que garante ao inventor o direito exclusivo de explorar sua
          invenção, impedindo terceiros de produzir, usar ou vender sem
          autorização. No Brasil, o Instituto Nacional da Propriedade Industrial
          (INPI) é o órgão responsável.
        </p>
        <div className="grid md:grid-cols-2 gap-4 mt-6">
          ...
          >
            ...
            <p className="text-blue-900/80 text-sm">
              Para produtos ou processos novos, com atividade inventiva.
              Proteção de 20 anos a partir do depósito. Clique para saber mais.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-emerald-900/80 text-sm">
              Para objetos de uso prático que tenham melhoria funcional em
              relação ao que já existe. Proteção de 15 anos. Clique para saber
              mais.
            </p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        {steps.map((step, idx) => (
          <div
            key={idx}
            className="flex bg-white p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-md transition-shadow"
          >
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-8">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200">
          ...
          <ul className="list-disc list-inside text-slate-600 space-y-1 text-sm">
            ...
            <li>
              <strong>Exame técnico:</strong> até 36 meses do depósito (código
              203)
            </li>
            <li>
              <strong>Anuidades:</strong> a partir do 2º ano, até o último mês do
...
${
  ...
  const exportToDocx = async () => {
    ...
    for (let line of lines) {
      ...
      const isMainTitle =
        trimmedLine ===
          (formData.titulo.toUpperCase() ||
            "[TÍTULO DO SEU PEDIDO DE PATENTE]") ||
    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between gap-4 mb-3">
        <p className="text-sm text-slate-500">
          Dados importados do Agente IA serão carregados automaticamente.
        </p>
        <button
          onClick={() => {
            const json = localStorage.getItem("inpi_agent_autodoc");
        ...
        <div className="flex flex-col h-full lg:h-auto">
          ...
          <div className="mt-4 bg-blue-50 p-3 rounded-lg border border-blue-200">
            <p className="text-xs text-blue-700 flex items-start gap-2">
              <Info className="w-4 h-4 flex-shrink-0 mt-0.5" />
              <span>
                <strong>Dica e-Patentes 4.0:</strong> Clique em "Gerar DOCX"
                para baixar este documento formatado corretamente e pronto para
                submissão ou para a inserção das imagens (no caso dos
                Desenhos).
              </span>
            </p>
          </div>
      ...
      <div className="space-y-8">
        <div className="border-l-4 border-emerald-500 pl-5">
          ...
          <ul className="list-disc list-inside text-slate-600 mt-2 space-y-1 ml-4">
            ...
            <li>
              Descrição detalhada (materiais, dimensões, funcionamento)
            </li>
        ...
        <div className="border-l-4 border-emerald-500 pl-5">
          ...
          <p className="text-slate-600 mt-2">
            Define o escopo de proteção legal. As reivindicações delimitam o
            que você quer proteger. Devem ser claras, concisas e apoiadas no
        ...
        <div className="border-l-4 border-emerald-500 pl-5">
          ...
          <p className="text-slate-600 mt-2">
            ...
            <strong>Não deve conter reivindicações</strong> nem ser usado para
        ...
        <div className="border-l-4 border-emerald-500 pl-5">
          ...
          <p className="text-slate-600 mt-2">
            ...
            para o entendimento da invenção. Devem ser numeradas
            sequencialmente (Figura 1, Figura 2...), com legendas claras.
          </p>
          <p className="text-sm text-slate-500 mt-2">
    ...
    <div className=" mx-auto">
      ...
      <div className="mt-6 p-3 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start gap-2">
        ...
        <div className="text-xs text-yellow-800">
          <strong>Atenção aos prazos:</strong> Anuidades vencem no último dia
          do mês do depósito. Exame técnico tem prazo fatal de 36 meses.
          Acompanhe a RPI todas as terças-feiras.
        </div>
      </div>
    </div>
  );
